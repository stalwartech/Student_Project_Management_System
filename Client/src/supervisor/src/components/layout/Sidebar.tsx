...
const NAV_ITEMS: {
  ...
  { to: "/supervisor/projects", label: "My Projects", icon: FolderOpen },
  { to: "/supervisor/students", label: "Assigned Students", icon: Users },
  { to: "/supervisor/feedback", label: "Feedback Inbox", icon: Inbox, showsFeedback: true },
  { to: "/supervisor/meetings", label: "Meetings", icon: CalendarDays },
  { to: "/supervisor/messages", label: "Messages", icon: MessageSquare, showsMessages: true },
  { to: "/supervisor/notifications", label: "Notifications", icon: Bell, showsUpdates: true },
];
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              {(item.showsUpdates ? updates.notifications : item.showsMessages ? updates.messages : item.showsFeedback ? updates.feedback : false) && (
