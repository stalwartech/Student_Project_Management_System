...
const NAV_ITEMS = [
  ...
  { to: "/supervisor/projects", label: "My Projects" },
  { to: "/supervisor/students", label: "Assigned Students" },
  { to: "/supervisor/feedback", label: "Feedback Inbox", showsFeedback: true },
  { to: "/supervisor/meetings", label: "Meetings" },
  { to: "/supervisor/messages", label: "Messages", showsMessages: true },
  { to: "/supervisor/notifications", label: "Notifications", showsUpdates: true },
];
