...
export function ActivatePage() {
  ...
  const handleStep3 = async (e: FormEvent) => {
    ...
    if (passwordForm.values.password.length < 8) {
          ...
          <div className="border-t border-gray-100 pt-6">
            ...
            {step === 1 && (
              <form onSubmit={handleStep1} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-blue-900 hover:bg-[#152750]" loading={loading}>
                  Send OTP
                </Button>
              </form>
            )}
            ...
            <p className="mt-4 text-center text-sm text-gray-500">
              <Link to="/coordinator/login" className="text-brand-600 hover:underline">
                Back to sign in
              </Link>
            </p>
          </div>
